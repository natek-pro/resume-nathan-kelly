...
- A prior review used pypdf, pdfplumber, and Poppler. The new contact stanza intentionally changes token counts; no permanent 1,832-token assertion is appropriate.
